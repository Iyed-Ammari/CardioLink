...
#[AsCommand(
    ...
    description: 'Créer un utilisateur PATIENT (ROLE_USER) pour tester les pages patient'
)]
final class CreatePatientCommand extends Command
{
    ...
    protected function execute(InputInterface $input, OutputInterface $output): int
    {
        ...
        // 3) Rôle patient (dans ton projet : ROLE_USER suffit)
        ...
        $output->writeln("<info>✅ Patient créé</info>");
